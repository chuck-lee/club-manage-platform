...
urlpatterns = patterns('',
    ...
    url(r'^subcategory/add/?$', views.AddSubCategory.as_view(), name='finance_subcategory_add'),
    url(r'^subcategory/change/(?P<pk>\d+)/?$', views.ChangeSubCategory.as_view(), name='finance_subcategory_change'),
    url(r'^subcategory/delete/(?P<pk>\d+)/?$', views.DeleteSubCategory.as_view(), name='finance_subcategory_delete'),
